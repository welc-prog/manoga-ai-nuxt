        ...
        <nav class="main-nav" :class="{ active: menuOpen }" id="main-nav" aria-label="Primary Navigation">
          <ul>
            ...
            <li class="has-dropdown" :class="{ 'dropdown-open': dropdownOpen }">
              ...
              <ul class="dropdown">
                <li><NuxtLink :to="localePath('/seo')" @click="closeMenu">SEO</NuxtLink></li>
                <li><NuxtLink :to="localePath('/google-ads')" @click="closeMenu">Google Ads</NuxtLink></li>
                <li><NuxtLink :to="localePath('/meta-advertising')" @click="closeMenu">{{ $t('nav.metaAds') }}</NuxtLink></li>
                <li><NuxtLink :to="localePath('/webdesign')" @click="closeMenu">{{ $t('nav.webdesign') }}</NuxtLink></li>
                <li><NuxtLink :to="localePath('/google-tag-manager')" @click="closeMenu">Google Tag Manager</NuxtLink></li>
              </ul>
            </li>
